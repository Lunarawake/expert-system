...
export function LogoutIcon({ size = 16, ...rest }) {
  return (
    <svg {...base(size)} {...rest}>
...
export function ShieldIcon({ size = 16, ...rest }) {
  return (
    <svg {...base(size)} {...rest}>
...
export function KeyIcon({ size = 16, ...rest }) {
  return (
    <svg {...base(size)} {...rest}>
...
export function UsersIcon({ size = 16, ...rest }) {
  return (
    <svg {...base(size)} {...rest}>
